      ...
      <div className="min-h-screen">
        <section className="relative h-[600px] flex items-center justify-center bg-gradient-to-r from-emerald-950 to-emerald-800 text-white">
          <div className="text-center px-4">
            ...
            <Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-[#d4af37] text-black px-10 py-4 rounded-lg font-bold inline-block">BOOK NOW</Link>
          </div>
        </section>
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        <section className="py-16 bg-white"><div className="max-w-4xl mx-auto px-4 text-center"><h2 className="text-3xl font-bold mb-4">Sea-Tac Airport ↔ Federal Way</h2><p className="text-xl text-gray-700 mb-6">16 miles | 20-35 minutes | From $85</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-emerald-700 text-white px-8 py-3 rounded-lg font-bold inline-block">Book Airport Transfer</Link></div></section>
      </div>
    </>
  );
}
...
export function SammamishPage() {
  return (
    <>
      ...
      <div className="min-h-screen">
        <section className="relative h-[600px] flex items-center justify-center bg-gradient-to-r from-emerald-900 to-emerald-700 text-white"><div className="text-center px-4"><h1 className="text-5xl font-extrabold mb-4">Sammamish Limo Service</h1><p className="text-xl mb-8">Klahanie, Pine Lake, Sahalee, Beaver Lake & all Sammamish neighborhoods</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-[#d4af37] text-black px-10 py-4 rounded-lg font-bold">BOOK NOW</Link></div></section>
        <section className="py-16 bg-white"><div className="max-w-4xl mx-auto px-4 text-center"><h2 className="text-3xl font-bold mb-6">Premium Sammamish Transportation</h2><p className="text-lg text-gray-700 mb-8">Serving Sammamish's upscale communities with luxury limo service to Sea-Tac, Bellevue, Seattle & beyond.</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-emerald-700 text-white px-8 py-3 rounded-lg font-bold">Book Your Ride</Link></div></section>
      </div>
    </>
  );
}
...
export function MercerIslandPage() {
  return (
    <>
      ...
      <div className="min-h-screen">
        <section className="relative h-[600px] flex items-center justify-center bg-gradient-to-r from-blue-900 to-emerald-800 text-white"><div className="text-center px-4"><h1 className="text-5xl font-extrabold mb-4">Mercer Island Limo Service</h1><p className="text-xl mb-8">Town Center, North End, South End & all island neighborhoods</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-[#d4af37] text-black px-10 py-4 rounded-lg font-bold">BOOK NOW</Link></div></section>
        <section className="py-16 bg-white"><div className="max-w-4xl mx-auto px-4 text-center"><h2 className="text-3xl font-bold mb-4">Mercer Island ↔ Sea-Tac Airport</h2><p className="text-xl mb-6">17 miles | 25-40 minutes | From $95</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-emerald-700 text-white px-8 py-3 rounded-lg font-bold">Book Airport Transfer</Link></div></section>
      </div>
    </>
  );
}
...
export function SeaTacPage() {
  return (
    <>
      ...
      <div className="min-h-screen">
        <section className="relative h-[600px] flex items-center justify-center bg-gradient-to-r from-sky-900 to-emerald-800 text-white"><div className="text-center px-4"><h1 className="text-5xl font-extrabold mb-4">SeaTac Limo Service<br /><span className="text-[#d4af37]">Airport & Hotel Transportation</span></h1><p className="text-xl mb-8">Sea-Tac Airport, Angle Lake, McMicken Heights & all SeaTac hotels</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-[#d4af37] text-black px-10 py-4 rounded-lg font-bold">BOOK AIRPORT LIMO</Link></div></section>
...
export function TukwilaPage() {
  return (
    <>
      ...
      <div className="min-h-screen">
        <section className="relative h-[600px] flex items-center justify-center bg-gradient-to-r from-emerald-900 to-gray-800 text-white"><div className="text-center px-4"><h1 className="text-5xl font-extrabold mb-4">Tukwila Limo Service</h1><p className="text-xl mb-8">Westfield Southcenter, Hotels, Foster & all Tukwila areas</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-[#d4af37] text-black px-10 py-4 rounded-lg font-bold">BOOK NOW</Link></div></section>
        <section className="py-16 bg-white"><div className="max-w-4xl mx-auto px-4 text-center"><h2 className="text-3xl font-bold mb-4">Southcenter Mall ↔ Sea-Tac Airport</h2><p className="text-xl mb-6">Just 6 miles | 10-18 minutes | From $70</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-emerald-700 text-white px-8 py-3 rounded-lg font-bold">Book Shopping Transfer</Link></div></section>
      </div>
    </>
  );
}
...
export function BurienPage() {
  return (
    <>
      ...
      <div className="min-h-screen">
        <section className="relative h-[600px] flex items-center justify-center bg-gradient-to-r from-green-900 to-emerald-800 text-white"><div className="text-center px-4"><h1 className="text-5xl font-extrabold mb-4">Burien Limo Service</h1><p className="text-xl mb-8">Downtown Burien, White Center, Seahurst & all neighborhoods</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-[#d4af37] text-black px-10 py-4 rounded-lg font-bold">BOOK NOW</Link></div></section>
        <section className="py-16 bg-white"><div className="max-w-4xl mx-auto px-4 text-center"><h2 className="text-3xl font-bold mb-4">Burien ↔ Sea-Tac Airport: From $75</h2><p className="text-lg text-gray-700 mb-6">Just 5 miles from the airport | 10-15 minute drive</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-emerald-700 text-white px-8 py-3 rounded-lg font-bold">Book Airport Ride</Link></div></section>
      </div>
    </>
  );
}
...
export function ShorelinePage() {
  return (
    <>
      ...
      <div className="min-h-screen">
        <section className="relative h-[600px] flex items-center justify-center bg-gradient-to-r from-blue-900 to-emerald-900 text-white"><div className="text-center px-4"><h1 className="text-5xl font-extrabold mb-4">Shoreline Limo Service</h1><p className="text-xl mb-8">Richmond Beach, Ridgecrest, Echo Lake & all Shoreline neighborhoods</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-[#d4af37] text-black px-10 py-4 rounded-lg font-bold">BOOK NOW</Link></div></section>
        <section className="py-16 bg-white"><div className="max-w-4xl mx-auto px-4 text-center"><h2 className="text-3xl font-bold mb-6">North Seattle Transportation</h2><p className="text-lg text-gray-700 mb-6">Shoreline ↔ Sea-Tac: From $100 | Shoreline ↔ Downtown Seattle: From $70</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-emerald-700 text-white px-8 py-3 rounded-lg font-bold">Book Your Ride</Link></div></section>
      </div>
    </>
  );
}
...
export function MapleValleyPage() {
  return (
    <>
      ...
      <div className="min-h-screen">
        <section className="relative h-[600px] flex items-center justify-center bg-gradient-to-r from-green-900 to-emerald-700 text-white"><div className="text-center px-4"><h1 className="text-5xl font-extrabold mb-4">Maple Valley Limo Service</h1><p className="text-xl mb-8">Town Center, Lake Wilderness, Black Diamond & surrounding areas</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-[#d4af37] text-black px-10 py-4 rounded-lg font-bold">BOOK NOW</Link></div></section>
        <section className="py-16 bg-white"><div className="max-w-4xl mx-auto px-4 text-center"><h2 className="text-3xl font-bold mb-4">Maple Valley ↔ Sea-Tac Airport</h2><p className="text-xl mb-6">28 miles | 35-50 minutes | From $115</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-emerald-700 text-white px-8 py-3 rounded-lg font-bold">Book Airport Transfer</Link></div></section>
      </div>
    </>
  );
}
...
export function CovingtonPage() {
  return (
    <>
      ...
      <div className="min-h-screen">
        <section className="relative h-[600px] flex items-center justify-center bg-gradient-to-r from-emerald-900 to-teal-800 text-white"><div className="text-center px-4"><h1 className="text-5xl font-extrabold mb-4">Covington Limo Service</h1><p className="text-xl mb-8">Town Center, Jenkins Creek, Timberlane & all Covington neighborhoods</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-[#d4af37] text-black px-10 py-4 rounded-lg font-bold">BOOK NOW</Link></div></section>
        <section className="py-16 bg-white"><div className="max-w-4xl mx-auto px-4 text-center"><h2 className="text-3xl font-bold mb-4">Covington ↔ Sea-Tac Airport: From $105</h2><p className="text-lg text-gray-700 mb-6">Professional limo service from southeast King County to Sea-Tac, Seattle & beyond.</p><Link href="https://customer.moovs.app/a1-charters-1/new/info" target="_blank" rel="noopener noreferrer" className="bg-emerald-700 text-white px-8 py-3 rounded-lg font-bold">Book Your Ride</Link></div></section>
      </div>
    </>
  );
}

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.tiktok.com/@emeraldcitylimos" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-white hover:text-[#d4af37] transition-colors">
                <TikTokIcon />  {/* TikTok icon is custom SVG */}
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-200">
              ...
              <li><a href="/services/hourly-charters" className="hover:text-[#d4af37] transition-colors">Hourly Charters</a></li>
              <li><a href="/services/wedding-transportation" className="hover:text-[#d4af37] transition-colors">Wedding Transportation</a></li>
              <li><a href="/services/game-day-transport" className="hover:text-[#d4af37] transition-colors">Game Day Transport</a></li>
              <li><a href="/services/special-occasions" className="hover:text-[#d4af37] transition-colors">Special Occasions</a></li>
              <li><a href="/services" className="hover:text-[#d4af37] transition-colors">Corporate Events</a></li>
              <li><a href="/services/executive-transportation" className="hover:text-[#d4af37] transition-colors">Executive Transportation</a></li>
              <li><a href="/services/cruise-transportation" className="hover:text-[#d4af37] transition-colors">Cruise Transportation</a></li>
            </ul>
          </div>

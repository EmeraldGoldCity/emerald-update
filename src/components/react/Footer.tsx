        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/" className="text-gray-200 hover:text-[#d4af37] transition-colors">Home</a></li>
              <li><a href="/services" className="text-gray-200 hover:text-[#d4af37] transition-colors">Services</a></li>
              <li><a href="/airport-transfers" className="text-gray-200 hover:text-[#d4af37] transition-colors">Airport Transfers</a></li>
              <li><a href="/locations" className="text-gray-200 hover:text-[#d4af37] transition-colors">Locations</a></li>
              <li><a href="/affiliates" className="text-gray-200 hover:text-[#d4af37] transition-colors">Become an Affiliate</a></li>
            </ul>
          </div>
